...
@ffi.Native<
  ffi.Void Function(
    ffi.Pointer<skottie_animation_t>,
    ffi.Pointer<sk_canvas_t>,
    ffi.Pointer<sk_rect_t>,
  )
>(isLeaf: true)
...
void skottie_animation_render_with_flags(
  ffi.Pointer<skottie_animation_t> instance,
  ffi.Pointer<sk_canvas_t> canvas,
  ffi.Pointer<sk_rect_t> dst,
  skottie_animation_renderflags_t flags,
) => _skottie_animation_render_with_flags(
  instance,
  canvas,
  dst,
  flags.value,
...
ffi.Pointer<skottie_animation_builder_t> skottie_animation_builder_new(
  skottie_animation_builder_flags_t flags,
) => _skottie_animation_builder_new(
  flags.value,
);
...
@ffi.Native<
  ffi.Pointer<skottie_animation_t> Function(
    ffi.Pointer<skottie_animation_builder_t>,
    ffi.Pointer<sk_stream_t>,
  )
>(isLeaf: true)
