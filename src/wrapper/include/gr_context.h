...
SK_C_API bool gr_context_is_supported(void);
SK_C_API void gr_direct_context_ref(gr_direct_context_t *context);
...
SK_C_API bool gr_direct_context_submit(gr_direct_context_t *context, const gr_submit_info_t *submitInfo);
...
SK_C_API gr_backendtexture_t *gr_backendtexture_new_gl(int width, int height, bool mipmapped, const gr_gl_textureinfo_t *glInfo, int64_t run_loop_handle);
SK_C_API gr_backendtexture_t *gr_backendtexture_new_vulkan(int width, int height, const gr_vk_imageinfo_t *vkInfo, int64_t run_loop_handle);
SK_C_API gr_backendtexture_t *gr_backendtexture_new_metal(int width, int height, bool mipmapped, const gr_mtl_textureinfo_t *mtlInfo, int64_t run_loop_handle);
SK_C_API gr_backendtexture_t *gr_backendtexture_new_direct3d(int width, int height, const gr_d3d_textureresourceinfo_t *d3dInfo, int64_t run_loop_handle);
