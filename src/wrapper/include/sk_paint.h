...
SK_C_API int64_t sk_paint_get_hash(const sk_paint_t* paint);
...
SK_C_API uint8_t sk_paint_get_alpha(const sk_paint_t*);
SK_C_API float sk_paint_get_alpha_f(const sk_paint_t*);
SK_C_API void sk_paint_set_alpha(sk_paint_t*, uint8_t a);
