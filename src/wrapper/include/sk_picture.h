...
SK_C_API sk_picture_t* sk_picture_recorder_end_recording_with_cull(sk_picture_recorder_t*, const sk_rect_t*);
...
SK_C_API sk_picture_t* sk_picture_make_placeholder(const sk_rect_t* cull);
