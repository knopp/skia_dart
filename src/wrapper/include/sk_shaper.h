...
SK_C_API sk_shaper_t* sk_shaper_new_hb_shaper_driven_wrapper(sk_unicode_t* unicode, sk_fontmgr_t* fallback);
SK_C_API sk_shaper_t* sk_shaper_new_hb_shape_then_wrap(sk_unicode_t* unicode, sk_fontmgr_t* fallback);
SK_C_API sk_shaper_t* sk_shaper_new_hb_shape_dont_wrap_or_reorder(sk_unicode_t* unicode, sk_fontmgr_t* fallback);
...
SK_C_API sk_shaper_font_run_iterator_t* sk_shaper_font_run_iterator_new(const char* utf8, size_t utf8Bytes, const sk_font_t* font, sk_fontmgr_t* fallback);
SK_C_API sk_shaper_font_run_iterator_t* sk_shaper_font_run_iterator_new_with_style(const char* utf8, size_t utf8Bytes, const sk_font_t* font, sk_fontmgr_t* fallback, const char* requestName, sk_fontstyle_t* requestStyle, const sk_shaper_language_run_iterator_t* languageIterator);
SK_C_API sk_shaper_font_run_iterator_t* sk_shaper_trivial_font_run_iterator_new(const sk_font_t* font, size_t utf8Bytes);
...
SK_C_API sk_shaper_bidi_run_iterator_t* sk_shaper_trivial_bidi_run_iterator_new(uint8_t bidiLevel, size_t utf8Bytes);
SK_C_API sk_shaper_bidi_run_iterator_t* sk_shaper_unicode_bidi_run_iterator_new(sk_unicode_t* unicode, const char* utf8, size_t utf8Bytes, uint8_t bidiLevel);
...
SK_C_API sk_shaper_script_run_iterator_t* sk_shaper_trivial_script_run_iterator_new(uint32_t script, size_t utf8Bytes);
SK_C_API sk_shaper_script_run_iterator_t* sk_shaper_hb_script_run_iterator_new(const char* utf8, size_t utf8Bytes);
SK_C_API sk_shaper_script_run_iterator_t* sk_shaper_hb_script_run_iterator_new_with_script(const char* utf8, size_t utf8Bytes, uint32_t script);
...
SK_C_API sk_shaper_language_run_iterator_t* sk_shaper_std_language_run_iterator_new(const char* utf8, size_t utf8Bytes);
SK_C_API sk_shaper_language_run_iterator_t* sk_shaper_trivial_language_run_iterator_new(const char* language, size_t utf8Bytes);
...
SK_C_API sk_shaper_run_handler_t* sk_shaper_run_handler_new(const sk_shaper_run_handler_procs_t* procs);
SK_C_API void sk_shaper_run_handler_delete(sk_shaper_run_handler_t* handler);

// TextBlobBuilderRunHandler

SK_C_API sk_textblob_builder_run_handler_t* sk_textblob_builder_run_handler_new(const char* utf8Text, sk_point_t offset);
