...
SK_C_API int sk_pixmap_get_width(const sk_pixmap_t* cpixmap);
SK_C_API int sk_pixmap_get_height(const sk_pixmap_t* cpixmap);
SK_C_API sk_colortype_t sk_pixmap_get_color_type(const sk_pixmap_t* cpixmap);
SK_C_API sk_alphatype_t sk_pixmap_get_alpha_type(const sk_pixmap_t* cpixmap);
SK_C_API bool sk_pixmap_is_opaque(const sk_pixmap_t* cpixmap);
SK_C_API void sk_pixmap_get_bounds(const sk_pixmap_t* cpixmap, sk_irect_t* bounds);
SK_C_API int sk_pixmap_get_row_bytes_as_pixels(const sk_pixmap_t* cpixmap);
SK_C_API int sk_pixmap_get_shift_per_pixel(const sk_pixmap_t* cpixmap);
SK_C_API size_t sk_pixmap_compute_byte_size(const sk_pixmap_t* cpixmap);
...
SK_C_API const void* sk_pixmap_get_addr(const sk_pixmap_t* cpixmap, int x, int y);
SK_C_API const uint8_t* sk_pixmap_get_addr8(const sk_pixmap_t* cpixmap, int x, int y);
SK_C_API const uint16_t* sk_pixmap_get_addr16(const sk_pixmap_t* cpixmap, int x, int y);
SK_C_API const uint32_t* sk_pixmap_get_addr32(const sk_pixmap_t* cpixmap, int x, int y);
SK_C_API const uint64_t* sk_pixmap_get_addr64(const sk_pixmap_t* cpixmap, int x, int y);
SK_C_API const uint16_t* sk_pixmap_get_addr_f16(const sk_pixmap_t* cpixmap, int x, int y);
SK_C_API void* sk_pixmap_get_writeable_addr(const sk_pixmap_t* cpixmap, int x, int y);
SK_C_API uint8_t* sk_pixmap_get_writeable_addr8(const sk_pixmap_t* cpixmap, int x, int y);
SK_C_API uint16_t* sk_pixmap_get_writeable_addr16(const sk_pixmap_t* cpixmap, int x, int y);
SK_C_API uint32_t* sk_pixmap_get_writeable_addr32(const sk_pixmap_t* cpixmap, int x, int y);
SK_C_API uint64_t* sk_pixmap_get_writeable_addr64(const sk_pixmap_t* cpixmap, int x, int y);
SK_C_API uint16_t* sk_pixmap_get_writeable_addr_f16(const sk_pixmap_t* cpixmap, int x, int y);
...
SK_C_API bool sk_pixmap_read_pixels_to_pixmap(const sk_pixmap_t* cpixmap, const sk_pixmap_t* dst, int srcX, int srcY);
