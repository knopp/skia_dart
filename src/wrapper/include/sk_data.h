...
SK_C_API sk_data_t* sk_data_new_share_subset(const sk_data_t* src, size_t offset, size_t length);
SK_C_API sk_data_t* sk_data_new_copy_subset(const sk_data_t* src, size_t offset, size_t length);
...
SK_C_API size_t sk_data_copy_range(const sk_data_t* src, size_t offset, size_t length, void* buffer);
