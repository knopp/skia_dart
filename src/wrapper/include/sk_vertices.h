...
SK_C_API uint32_t sk_vertices_get_unique_id(sk_vertices_t* cvertices);
SK_C_API void sk_vertices_get_bounds(sk_vertices_t* cvertices, sk_rect_t* bounds);
SK_C_API size_t sk_vertices_get_approximate_size(sk_vertices_t* cvertices);
