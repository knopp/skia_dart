...
SK_C_API skresources_resource_provider_t* skresources_file_resource_provider_make(sk_string_t* base_dir, sk_imagedecodingstrategy_t strategy);
...
SK_C_API skresources_resource_provider_t* skresources_data_uri_resource_provider_proxy_make(skresources_resource_provider_t* rp, sk_imagedecodingstrategy_t strategy);
