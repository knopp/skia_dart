...
SK_C_API void sk_colorspace_transfer_fn(const sk_colorspace_t* colorspace, sk_colorspace_transfer_fn_t* transferFn);
SK_C_API void sk_colorspace_inv_transfer_fn(const sk_colorspace_t* colorspace, sk_colorspace_transfer_fn_t* transferFn);
SK_C_API bool sk_colorspace_to_xyzd50(const sk_colorspace_t* colorspace, sk_colorspace_xyz_t* toXYZD50);
SK_C_API void sk_colorspace_gamut_transform_to(const sk_colorspace_t* src, const sk_colorspace_t* dst, sk_colorspace_xyz_t* src_to_dst);
