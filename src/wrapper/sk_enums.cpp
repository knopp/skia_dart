...
// sk_path_arc_size_t
static_assert((int)SkPathBuilder::ArcSize::kLarge_ArcSize == (int)LARGE_SK_PATH_BUILDER_ARC_SIZE, ASSERT_MSG(SkPathBuilder::ArcSize, sk_path_arc_size_t));
static_assert((int)SkPathBuilder::ArcSize::kSmall_ArcSize == (int)SMALL_SK_PATH_BUILDER_ARC_SIZE, ASSERT_MSG(SkPathBuilder::ArcSize, sk_path_arc_size_t));
...
// sk_imagedecodestrategy_t
static_assert((int)skresources::ImageDecodeStrategy::kLazyDecode == (int)IMAGE_DECODING_LAZY_DECODE, ASSERT_MSG(skresources::ImageDecodeStrategy, sk_imagedecodestrategy_t));
static_assert((int)skresources::ImageDecodeStrategy::kPreDecode == (int)IMAGE_DECODING_PRE_DECODE, ASSERT_MSG(skresources::ImageDecodeStrategy, sk_imagedecodestrategy_t));
