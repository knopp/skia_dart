...
#include "wrapper/include/sk_font.h"
...
void sk_font_unichars_to_glyphs(const sk_font_t* font, const int32_t uni[], int count, uint16_t glyphs[]) {
  AsFont(font)->unicharsToGlyphs({uni, count}, {glyphs, count});
}
